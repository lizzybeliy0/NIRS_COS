 ...
 * Полосы: 0-100, 100-951, 951-2219, 2219-4755, 4755-9827, 9827-19971 Гц
 */
public class Equalizer implements Filter {
    ...
    private static final double[][] BAND_RANGES = {
            {0, 100},       // Полоса 1: 0-100 Гц
            {100, 951},     // Полоса 2: 100-951 Гц
    ...
    private static final double[][][] BAND_COEFFS = {
            // Полоса 1 (0-100 Гц) - ФНЧ
            null, // ФНЧ обрабатывается отдельно
            // Полоса 2 (100-951 Гц) - полосовой
            {
    ...
    private void initIIRFilters() {
        // Полоса 1: ФНЧ 100 Гц (6 порядок)
        bands[0] = new ButterworthIIR(6, 100.0, "lowpass", 44100.0, 1.0);
